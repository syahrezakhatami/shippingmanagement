<aside class="main-sidebar">
    ...
    <div class="user-panel">
        ...
        <p style="font-size:60%;"><?php echo $this->session->userdata('group_name')?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($user_permission): ?>
            ...
            <li class="treeview" id="mainGroupNav">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createGroup', $user_permission)): ?>
                  <li id="addGroupNav"><a href="<?php echo base_url('groups/create') ?>"><i class="fa fa-circle-o"></i> Add Warehouse</a></li>
                <?php endif; ?>
                <?php if(in_array('updateGroup', $user_permission) || in_array('viewGroup', $user_permission) || in_array('deleteGroup', $user_permission)): ?>
                <li id="manageGroupNav"><a href="<?php echo base_url('groups') ?>"><i class="fa fa-circle-o"></i> Manage Warehouse</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
          ...
          <?php if(in_array('createBrand', $user_permission) || in_array('updateBrand', $user_permission) || in_array('viewBrand', $user_permission) || in_array('deleteBrand', $user_permission)): ?>
            <li id="brandNav">
              <a href="<?php echo base_url('limit/') ?>">
                <i class="glyphicon glyphicon-tags"></i> <span>Limit Warehouse</span>
              </a>
            </li>
          <?php endif; ?>
          ...
          <?php if(in_array('createStore', $user_permission) || in_array('updateStore', $user_permission) || in_array('viewStore', $user_permission) || in_array('deleteStore', $user_permission)): ?>
            <li id="storeNav">
              <a href="<?php echo base_url('status_paid/') ?>">
                <i class="fa fa-files-o"></i> <span>Paid Status</span>
              </a>
            </li>
          <?php endif; ?>
          <?php if(in_array('createStore', $user_permission) || in_array('updateStore', $user_permission) || in_array('viewStore', $user_permission) || in_array('deleteStore', $user_permission)): ?>
