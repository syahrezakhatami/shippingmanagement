        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="brands">Warehouse</label>
                  <?php $warehouse_data = json_decode($product_data['group_id']); ?>
                  <select class="form-control" id="groups" name="groups">
                    <?php foreach ($groups as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>"<?php if($product_data['group_id'] == $v['id']) { echo "selected='selected'"; } ?>><?php echo $v['group_name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
