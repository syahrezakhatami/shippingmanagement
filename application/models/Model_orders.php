...
class Model_orders extends CI_Model
{
	...
	public function create()
	{
		...
		$bill_no = 'DND-'.strtoupper(substr(md5(uniqid(mt_rand(), true)), 0, 4));
    	$data = array(
    		'bill_no' => $bill_no,
    	...
    	for($x = 0; $x < $count_product; $x++) {
    		$items = array(
				...
				'panjang' =>  $this->input->post('panjang')[$x],
				'lebar' =>  $this->input->post('lebar')[$x],
				'tinggi' =>  $this->input->post('tinggi')[$x],
				'dimensi' =>  $this->input->post('dimension_value')[$x],
				'berat' =>  $this->input->post('berat')[$x],
				'biaya' =>  $this->input->post('biaya_value')[$x],
    		);
